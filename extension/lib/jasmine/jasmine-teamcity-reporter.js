(function(global) {
    ...
    exportObject.TeamCityReporter = function() {
        ...
        self.specStarted = function(spec) {
            ...
            Nimble.log('\<span style="color: green;"><strong>==== Started ' + spec.description + ' ====\</strong></span>');
        };
        ...
        self.jasmineDone = function() {
            ...
            // Nimble: Pass msgs back to the extension
            chrome.runtime.sendMessage({NimbleMsg: 'JasmineDone'});
